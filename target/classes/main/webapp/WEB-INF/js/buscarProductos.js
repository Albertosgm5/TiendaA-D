				...
				success : function(response) {
					...
					for (var i = 0; i < lista.length; i++) {
						...
						var fila =	"<div class='card' style='width: 12rem; display: inline-block; margin: 20px;'>"
									+ "<div><img src='/A&DStore/producto/imagen/"+lista[i].idProducto+"' style='WIDTH: 12rem; HEIGHT: 12rem;'>"
									+ "</div>"
									+ "<div class='card-body'>"
									+ "<h5 class='card-title'>"+lista[i].nombreProducto+"</h5>"
									+ "<p class='card-text'>"+lista[i].descripcion+"</p>"
									+ "<a class='btn btn-primary' href='/A&DStore/producto/detallesProducto/"+lista[i].idProducto+"'> Detalles </a>"
									+ "</div>"
